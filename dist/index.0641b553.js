...
var _easytimerJs = require("easytimer.js");
var _easytimerJsDefault = parcelHelpers.interopDefault(_easytimerJs);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
var timer = new (0, _easytimerJsDefault.default)();
let audioUrl = new URL(require("1b4d335c49224329"));
let audioTickingUrl = new URL(require("91bf1d8b1904d1f2"));
(0, _jqueryDefault.default)("#chronoExample .playBoom").click(function() {
...
function timerWithSound(secs) {
    ...
    (0, _jqueryDefault.default)("#chronoExample .values").html(timer.getTimeValues().toString());
    var audio = new Audio(audioTickingUrl);
    audio.play();
}
(0, _jqueryDefault.default)("#chronoExample .3secTimer").click(function() {
    timerWithSound(3);
});
(0, _jqueryDefault.default)("#chronoExample .5minutesTimer").click(function() {
    timerWithSound(300);
});
(0, _jqueryDefault.default)("#chronoExample .10minutesTimer").click(function() {
    timerWithSound(600);
});
(0, _jqueryDefault.default)("#chronoExample .15minutesTimer").click(function() {
    timerWithSound(900);
});
(0, _jqueryDefault.default)("#chronoExample .30minutesTimer").click(function() {
    timerWithSound(1800);
});
...
timer.addEventListener("targetAchieved", function(e) {
    (0, _jqueryDefault.default)("#chronoExample .values").html("BOOM!!");
    var audio = new Audio(audioUrl);
    audio.play();
});

},{"easytimer.js":"a8NBE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","jquery":"hgMhh","1b4d335c49224329":"1ie0I","91bf1d8b1904d1f2":"953ms"}],"a8NBE":[function(require,module,exports) {
/**
 * easytimer.js
...
},{}],"1ie0I":[function(require,module,exports) {
module.exports = require("2815e299bd193b1c").getBundleURL("lPpKD") + "boom.d35cc092.mp3" + "?" + Date.now();

},{"2815e299bd193b1c":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"953ms":[function(require,module,exports) {
module.exports = require("ca206012cf7a32d7").getBundleURL("lPpKD") + "tick.66b16ff9.mp3" + "?" + Date.now();

},{"ca206012cf7a32d7":"lgJ39"}]},["lKzq4","bNKaB"], "bNKaB", "parcelRequireb7bb")
